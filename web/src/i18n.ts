...
const MESSAGES: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "accessKeys.subtitle": "Manage credentials used by proxy and MCP clients.",
    "accessKeys.usage":
      "Use an access key as a Bearer token when calling the proxy or MCP endpoint.",
    "accessKeys.add": "Add Access Key",
    "accessKeys.addModal.title": "Add Access Key",
    "accessKeys.addModal.name": "Name",
    "accessKeys.addModal.namePlaceholder": "For example: Desktop or Automation",
    "accessKeys.addModal.create": "Create Access Key",
    "accessKeys.table.name": "Name",
    "accessKeys.table.key": "Access Key",
    "accessKeys.table.createdAt": "Created At",
    "accessKeys.table.actions": "Actions",
    "accessKeys.actions.show": "Show key",
    "accessKeys.actions.hide": "Hide key",
    "accessKeys.actions.copy": "Copy key",
    "accessKeys.actions.delete": "Delete key",
    "accessKeys.confirm.delete":
      "Delete this access key? Clients using it will immediately lose access.",
    "accessKeys.errors.load": "Failed to load access keys",
    "accessKeys.messages.created": "Access key created",
  ...
  "zh-CN": {
    ...
    "accessKeys.subtitle": "管理代理与 MCP 客户端使用的访问凭据。",
    "accessKeys.usage":
      "调用代理接口或 MCP 端点时，请将访问密钥作为 Bearer Token 使用。",
    "accessKeys.add": "添加访问密钥",
    "accessKeys.addModal.title": "添加访问密钥",
    "accessKeys.addModal.name": "名称",
    "accessKeys.addModal.namePlaceholder": "例如：桌面端或自动化任务",
    "accessKeys.addModal.create": "创建访问密钥",
    "accessKeys.table.name": "名称",
    "accessKeys.table.key": "访问密钥",
    "accessKeys.table.createdAt": "创建时间",
    "accessKeys.table.actions": "操作",
    "accessKeys.actions.show": "显示密钥",
    "accessKeys.actions.hide": "隐藏密钥",
    "accessKeys.actions.copy": "复制密钥",
    "accessKeys.actions.delete": "删除密钥",
    "accessKeys.confirm.delete":
      "确定删除该访问密钥吗？正在使用它的客户端将立即无法访问。",
    "accessKeys.errors.load": "访问密钥加载失败",
    "accessKeys.messages.created": "访问密钥已创建",
